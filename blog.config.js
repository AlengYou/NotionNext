...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '19b44072b72d80bf82b7e7bdacca9fdd,en:19b44072b72d80bf82b7e7bdacca9fdd',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Aleng', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '熱愛敲code的工程師', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.aleng.blog', // 网站地址
  KEYWORDS:
    process.env.NEXT_PUBLIC_KEYWORD || 'Aleng, 工程師, 前端工程師, next.js', // 网站关键词 英文逗号隔开
