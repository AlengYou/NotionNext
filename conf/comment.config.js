...
module.exports = {
  ...
  COMMENT_UTTERRANCES_REPO:
    ...
    'AlengYou/aleng-blog-comment', // 你的代码仓库名， 例如我是 'tangly1024/NotionNext'； 更多文档参考 https://utteranc.es/
  ...
  COMMENT_GITALK_REPO:
    process.env.NEXT_PUBLIC_COMMENT_GITALK_REPO || 'aleng-blog-comment', // 你的Github仓库名，例如 'NotionNext'
  COMMENT_GITALK_OWNER:
    process.env.NEXT_PUBLIC_COMMENT_GITALK_OWNER || 'AlengYou', // 你的用户名 e.g tangly1024
  COMMENT_GITALK_ADMIN:
    process.env.NEXT_PUBLIC_COMMENT_GITALK_ADMIN || 'AlengYou', // 管理员用户名、一般是自己 e.g 'tangly1024'
  COMMENT_GITALK_CLIENT_ID:
    process.env.NEXT_PUBLIC_COMMENT_GITALK_CLIENT_ID || 'Ov23lir4ylHHf5ZkqlO5', // e.g 20位ID ， 在gitalk后台获取
  COMMENT_GITALK_CLIENT_SECRET:
    process.env.NEXT_PUBLIC_COMMENT_GITALK_CLIENT_SECRET ||
    '7d664df22db7b83d0df26d3e4e16d8fdd53f4268', // e.g 40位ID， 在gitalk后台获取
